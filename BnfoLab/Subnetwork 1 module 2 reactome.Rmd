...
> There are over 17,000 cells detected and all of them are multiplets
...
```{r setup}
knitr::opts_knit$set(root.dir = "~/Desktop/VCU/G1/Bioinformatics/CCTR691_scRNASeq")
```
...
> It lists 2575 samples which are the individual cells within the PDX sample. The 19612 features are the total genes that are detected across all the cells. 
...
> The cells that were filtered out had low nFeature and nCount values
...
> The variability of the gene expression decreases
...
> 3 dimensions looks pretty similar to 5 dimensions but slightly less spread
...
> 1 dimension is much less spread out
...
> 10 dimensions is more uniformly spread
